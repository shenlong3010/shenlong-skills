---
name: crawl4ai
description: Complete toolkit for web crawling and data extraction using Crawl4AI. Use when you need to scrape websites, extract structured data, handle JavaScript-heavy pages, crawl multiple URLs, or build automated web data pipelines. Includes optimized extraction patterns with schema generation for efficient, LLM-free extraction.
derivation: copied
