...
4. Distinguish failure classes: technical (it breaks), adoption (nobody uses it), maintenance (it rots), boundary (it leaks something it shouldn't). A plan strong in one class routinely dies in another.
